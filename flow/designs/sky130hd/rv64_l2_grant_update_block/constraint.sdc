current_design rv64_l2_grant_update_block
...
set constrained_outputs [all_outputs]

set io_delay_max [expr $clk_period * $clk_io_pct]
set io_delay_min 0.20
...
set_output_delay -max $io_delay_max -clock $clk_name $constrained_outputs
set_output_delay -min $io_delay_min -clock $clk_name $constrained_outputs
...
set_load 0.005 $constrained_outputs

set_false_path -from [get_ports rst_n]
set_clock_uncertainty 0.05 [get_clocks $clk_name]
