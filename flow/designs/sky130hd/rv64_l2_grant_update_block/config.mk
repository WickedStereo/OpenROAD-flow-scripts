export DESIGN_NICKNAME = rv64_l2_grant_update_block
export DESIGN_NAME     = rv64_l2_grant_update_block
export PLATFORM        = sky130hd

export VERILOG_FILES = ./designs/src/rv64_cache_system/l2/rv64_l2_grant_update_block.v \
