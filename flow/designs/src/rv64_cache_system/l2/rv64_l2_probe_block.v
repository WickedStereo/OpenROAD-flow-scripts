...
module rv64_l2_probe_block #(
    ...
    reg [15:0]              dir_rd_valid_q;
    reg [16*CORES-1:0]      dir_rd_sharers_q;
    reg [15:0]              dir_rd_owner_valid_q;
    reg [16*$clog2(CORES)-1:0] dir_rd_owner_id_q;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            dir_rd_sharers_q <= {(16*CORES){1'b0}};
            dir_rd_owner_valid_q <= 16'd0;
            dir_rd_owner_id_q <= {(16*$clog2(CORES)){1'b0}};
